...
import './login.css';
import {LoginByEmail} from "../../../wailsjs/go/app/App";
    ...
    return (
        <div className="form_container">
            ...
            <div className="title_container">
                ...
                <span
                    className="subtitle">开始使用应用程序，只需登录 bemfa 账户即可享受体验</span>
            </div>
            <div className="input_container">
                ...
                <input placeholder="name@mail.com" title="Inpit title" name="input-name" type="text"
                       className="input_field" id="email_field" value={email}
            ...
            <div className="input_container">
                ...
                <input placeholder="Password" title="Inpit title" name="input-name" type="password"
                       className="input_field" id="password_field" value={password}
                       onChange={(e) => setPassword(e.target.value)}/>
            </div>
            <button title="Sign In" onClick={login} className="sign-in_btn">
                <span>Sign In</span>
            </button>
            ...
            {/*    <svg height="18" width="18" viewBox="0 0 32 32" xmlnsXlink="http://www.w3.org/1999/xlink"*/}
            ...
            {/*</button>*/}
            <button title="Create Account" onClick={createAccount} className="create_account_btn">
