        ...
        <div className="container">
            <div className="login-form">
                <div className="header">
                    ...
                    <p className="description">立即创建您的帐户，即可享受 bemfa .</p>
                </div>
                <div className="input_container">
                    ...
                    <input id="email_field" className="input_field" type="text" name="input-name" title="Inpit title"
                ...
                <div className="input_container">
                    ...
                    <input id="password_field" className="input_field" type="password" name="input-name" title="Inpit title"
                           placeholder="Password"/>
                </div>
                <button className="create_account_btn1"  title="Create Account">
                    <span>Create Account</span>
                </button>
                <button className="sign-in_btn1" onClick={login} title="Sign In">
                    <span>Sign In</span>
                </button>
            </div>
            <div className="testimonial">
                <p>"专注于开源，智造，创新，分享。关注硬件与创新，突破技术极限，面向未来，我们是认真的。
                    崇尚开源，发掘未知--巴法科技."</p>
                <div className="user-profile-picture">
                    <img src="https://cloud.bemfa.com/tcp/img/logo_b.e9fe691d.png"/>
                </div>
                <div className="user">
                    <span className="username">巴法云</span>
                    <span className="occupation">Creative Designer &amp; Developer</span>
                </div>
            </div>
        </div>
    );
